...
#define SYS_EVENT_PROVISIONING_IN_PROGRESS BIT11
#define SYS_EVENT_PROVISIONING_GOT_SSID BIT12

#define SYS_EVENT_PROVISIONING_BITS (SYS_EVENT_PROVISIONING_IN_PROGRESS | SYS_EVENT_PROVISIONING_GOT_SSID | SYS_EVENT_BLE_CONNECTED)